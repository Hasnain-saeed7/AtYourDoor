  ...
  return (
    <div className="flex items-center gap-2 flex-shrink-0">
      <button
        onClick={() => updateStatus('APPROVED')}
        disabled={loading !== null}
        className="flex items-center gap-2 bg-green-500/10 hover:bg-green-500/20 disabled:opacity-50 text-green-400 text-sm font-bold px-5 py-2.5 rounded-xl border border-green-500/20 transition-all hover:-translate-y-0.5"
      >
        {loading === 'APPROVED' ? (
          <svg className="animate-spin w-4 h-4" viewBox="0 0 24 24" fill="none">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/>
      ...
      <button
        onClick={() => updateStatus('REJECTED')}
        disabled={loading !== null}
        className="flex items-center gap-2 bg-red-500/10 hover:bg-red-500/20 disabled:opacity-50 text-red-400 text-sm font-bold px-5 py-2.5 rounded-xl border border-red-500/20 transition-all hover:-translate-y-0.5"
      >
        {loading === 'REJECTED' ? (
          <svg className="animate-spin w-4 h-4" viewBox="0 0 24 24" fill="none">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/>
